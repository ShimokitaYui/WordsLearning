...
Q_CONSTINIT static const uint qt_meta_data_CLASSSettingDialogENDCLASS[] = {
 ...
 // signals: name, argc, parameters, tag, flags, initial metatype offsets
       ...
       4,    0,   56,    2, 0x06,    5 /* Public */,
       5,    1,   57,    2, 0x06,    6 /* Public */,
...
void SettingDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->getPath((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->getFileName((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 2: _t->handleClosed(); break;
        case 3: _t->readFile((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        ...
        {
            using _t = void (SettingDialog::*)(QString );
            if (_t _q_method = &SettingDialog::getPath; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SettingDialog::*)(QString );
            if (_t _q_method = &SettingDialog::getFileName; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &SettingDialog::handleClosed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (SettingDialog::*)(QString );
            if (_t _q_method = &SettingDialog::readFile; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 0
void SettingDialog::getPath(QString _t1)
{
...
// SIGNAL 1
void SettingDialog::getFileName(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 2
void SettingDialog::handleClosed()
{
    QMetaObject::activate(this, &staticMetaObject, 2, nullptr);
}

// SIGNAL 3
void SettingDialog::readFile(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
